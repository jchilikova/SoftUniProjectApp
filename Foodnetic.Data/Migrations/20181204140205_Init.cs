        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DailyMenuId = table.Column<string>(nullable: true),
                    VirtualFridgeId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VirtualFridges", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VirtualFridges_AspNetUsers_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecipeMenus", x => new { x.RecipeId, x.MenuId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_VirtualFridges_VirtualFridgeId",
                        column: x => x.VirtualFridgeId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_VirtualFridgeId",
                table: "Products",
                column: "VirtualFridgeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VirtualFridges_OwnerId",
